...
import org.openmrs.module.appointmentapp.UiCommonsConstants;
...
public class SessionInfoPageController {
    ...
    public String get( UiUtils ui,
        ...
        return "redirect:/appointmentapp/findPatient.page?app=appointmentschedulingui.schedulingAppointmentApp";
    }
}

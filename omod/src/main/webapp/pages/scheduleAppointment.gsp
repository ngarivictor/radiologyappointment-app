    ...
    <div class="container">
        <div class="example">
            <ul id="breadcrumbs">
                ...
                <li>
                    <i class="icon-chevron-right link"></i>
                    ${ui.message("appointmentapp.ScheduleAppointments.schedule.title")}
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="patient-header new-patient-header">
        <div class="demographics">
            <h1 class="name" style="border-bottom: 1px solid #ddd;">
                <span>&nbsp;${ui.message("appointmentapp.ScheduleAppointments.schedule.title")} &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</span>
            </h1>
        </div>
        ...
        <div class="patient-header new-patient-header">
            <div class="demographics">
                <h1 class="name">
                    <span id="surname">${patient.patient.names.familyName},<em>surname</em></span>
                    <span id="othname">${patient.patient.names.givenName} &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<em>other names</em>
                    </span>
            ...
            <div class="identifiers">
                <em>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Patient ID</em>
                <span>${patient.getPrimaryIdentifier()}</span>
            </div>

            <div id="appointmentscheduling-manageAppointments">
                ${ui.includeFragment("appointmentapp", "patientAppointments", [patient: patient.patient, enablePagination: true])}
                ${ui.includeFragment("appointmentapp", "patientAppointmentRequests", [patient: patient.patient, canBook: canBook])}
                <% if (canBook) { %>
                ${ ui.includeFragment("appointmentapp", "scheduleAppointment", [ patient: patient.patient, returnUrl: returnUrl  ]) }
                <% } %>
            </div>
        </div>
    </div>
